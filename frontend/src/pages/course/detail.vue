<template>
  <view class="page">
    ...
    <view class="course-cover">
      <image :src="course.cover_image_signed_url || course.cover_image || course.cover" mode="aspectFill" />
    ...
    >
      <view class="video-cover-wrapper" @click="handleTrialPlay">
        <image :src="course.cover_image_signed_url || course.cover_image || course.cover" mode="aspectFill" class="video-cover-img" />
        <!-- 试看遮罩 -->
    ...
    <view class="video-section card" v-else-if="course.video_key && signedVideoSrc">
      <video
        class="video-player"
        :src="signedVideoSrc"
        :poster="course.cover_image_signed_url || course.cover_image || course.cover"
        controls
        show-fullscreen-btn
        object-fit="contain"
        enable-danmu
